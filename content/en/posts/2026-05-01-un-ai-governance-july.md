...
The [Commission on Science and Technology for Development (CSTD) convened its 29th Session](https://unctad.org/meeting/commission-science-and-technology-development-29th-session) under the theme "Science, Technology and Innovation in the Age of AI." The agenda spanned data governance frameworks, technology transfer commitments, capacity building, and the 20-year follow-up to the World Summit on the Information Society. But threading through the discussions was a fundamental question: as AI reshapes development, who gets to build and govern it—and who is excluded?
...
[1] [CSTD 29th Session — Opening Plenary and Ministerial Roundtable](https://webtv.un.org/en/asset/k1z/k1zdnx65rt) — Remarks by Doreen Bogdan-Martin, ITU Secretary-General. April 20–24, 2026.

[2] [Geoffrey Hinton on AI governance](https://soundcloud.com/unradio/godfather-of-ai-geoffrey) — Remarks at the Digital World Conference (DWC): AI for Social Development, co-organized by UNRISD in Geneva. UN Radio, April 23, 2026.
