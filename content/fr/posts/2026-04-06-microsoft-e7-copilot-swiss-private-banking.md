...
Le [PFPDT](https://www.edoeb.admin.ch/fr/traitement-de-donnees-dans-un-nuage-informatique) — le Préposé fédéral à la protection des données et à la transparence — a publié des orientations sur le traitement des données dans le cloud et des prises de position sur l'utilisation de fournisseurs cloud américains qui sont directement pertinentes ici. Toute banque effectuant son évaluation des risques liés au CLOUD Act devrait prendre en compte les orientations du PFPDT parallèlement à l'évaluation des risques exigée par la FINMA, car les positions du Préposé sur l'accès transfrontalier aux données et la portée juridictionnelle américaine informent le standard de diligence attendu en vertu de la loi suisse sur la protection des données.
